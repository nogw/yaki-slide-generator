defmodule Yaki do
  ...
  defparsec(:image, md_image)
  defparsec(:italic, md_italic)
  defparsec(:bold, md_bold)
  defparsec(:link, md_link)
  defparsec(:parse, choice([heading, atx_end]))
